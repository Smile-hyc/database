...
本系统面向足球爱好者和实况足球玩家，提供国家队、球员、球员卡、世界杯比赛、竞猜、积分结算和球员卡行情查询功能。系统 seed 数据包含 48 支 2026 世界杯 A-L 组球队、192 名代表球员、192 张课程演示球员卡和按公开赛程 Match 1-72 整理的 72 场小组赛。系统重点展示数据库事务、触发器、存储过程和视图，满足数据库工程课程设计要求。

数据来源说明：

- 赛程、球队和球员名单参考 FIFA 官方赛程/球队/大名单页面及公开足球资料；小组赛时间统一按北京时间展示。
